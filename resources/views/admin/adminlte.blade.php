...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	No Invoice  		<input type="text" onkeyup="isi_otomatis()" id="id_p">
	<input type="submit" value="View" id="nom"><br>
      <!-- Default box -->
      <div class="card">
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th style="width: 40px">Unit Price</th>
                  ...
                  <blockquote class="blockquote text-right">Sub total<br>
                  Courier Free<br>
                  Total</blockquote>
